...
const PAGE_GROUPS = [
  {
    ...
    label: 'Конференция',
    pages: [
      { id: 'conference_intro', name: 'Введение', path: '/conference/introduction' },
      { id: 'conference_goals', name: 'Цели', path: '/conference/goals' },
      { id: 'conference_date_venue', name: 'Дата и место', path: '/conference/date-venue' },
      { id: 'conference_participation', name: 'Участие', path: '/conference/participation' },
    ]
  },
  {
    id: 'program',
    label: 'Программа',
    pages: [
      { id: 'program_structure', name: 'Структура программы', path: '/program/structure' },
      { id: 'program_plenary', name: 'Пленарное заседание', path: '/program/plenary' },
      { id: 'program_events', name: 'Мероприятия конференции', path: '/program/events' },
      { id: 'program_forums', name: 'Форумы', path: '/program/forums' },
    ]
  },
  {
    id: 'events',
    label: 'Мероприятия',
    pages: [
      { id: 'parallel_events', name: 'Параллельные мероприятия', path: '/events/parallel' },
      { id: 'cultural_events', name: 'Культурные мероприятия', path: '/events/cultural' },
      { id: 'events_khisor', name: 'Хисор', path: '/events/khisor' },
      { id: 'events_rogun', name: 'Рогун', path: '/events/rogun' },
      { id: 'events_dushanbe', name: 'Душанбе', path: '/events/dushanbe' },
    ]
  },
  {
    id: 'registration',
    label: 'Регистрация',
    pages: [
      { id: 'registration_page', name: 'Регистрация', path: '/registration' },
    ]
  },
  {
    id: 'logistics',
    label: 'Логистика',
    pages: [
      { id: 'logistics_practical', name: 'Практическая информация', path: '/logistics/practical' },
      { id: 'logistics_visa', name: 'Виза в Таджикистан', path: '/logistics/visa' },
      { id: 'logistics_press', name: 'Аккредитация прессы', path: '/logistics/press' },
      { id: 'logistics_flights', name: 'Авиарейсы', path: '/logistics/flights' },
      { id: 'logistics_accommodation', name: 'Размещение', path: '/logistics/accommodation' },
      { id: 'logistics_weather', name: 'Погода', path: '/logistics/weather' },
    ]
  }
]
...
export default function EventsSubpagesManager({ initialPage = null }) {
  const { token } = useAuth()
  ...
  return (
    <div className="elementor-builder">
      ...
      {/* Page Tabs — hidden when opened with a specific initialPage */}
      {!initialPage && (
        <div className="elementor-page-tabs" style={{ flexWrap: 'wrap', gap: '4px' }}>
          {PAGE_GROUPS.map(group => (
            <div key={group.id} style={{ display: 'flex', alignItems: 'center', gap: '4px', marginRight: '12px' }}>
              <span style={{ fontSize: '11px', color: '#6b7280', fontWeight: '600', textTransform: 'uppercase', marginRight: '4px' }}>{group.label}:</span>
