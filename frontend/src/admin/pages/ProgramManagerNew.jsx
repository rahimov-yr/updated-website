...
const PAGES = {
  // Мероприятия
  PARALLEL: { id: 'parallel_events', name: 'Параллельные мероприятия', slug: 'parallel' },
  CULTURAL: { id: 'cultural_events', name: 'Культурные мероприятия', slug: 'cultural' },
  KHISOR: { id: 'khisor_excursion', name: 'Хисор', slug: 'khisor' },
  ROGUN: { id: 'rogun_excursion', name: 'Рогун', slug: 'rogun' },
  DUSHANBE: { id: 'dushanbe_excursion', name: 'Душанбе', slug: 'dushanbe' },

  // Конференции
  CONF_INTRO: { id: 'conference_intro', name: 'Введение', slug: 'intro' },
  CONF_GOALS: { id: 'conference_goals', name: 'Цели', slug: 'goals' },
  CONF_VENUE: { id: 'conference_venue', name: 'Дата и место проведения', slug: 'venue' },
  CONF_PARTICIPATION: { id: 'conference_participation', name: 'Участие', slug: 'participation' },

  // Программа
  PROG_STRUCTURE: { id: 'program_structure', name: 'Структура программы', slug: 'structure' },
  PROG_PLENARY: { id: 'program_plenary', name: 'Пленарное заседание', slug: 'plenary' },
  PROG_EVENTS: { id: 'program_events', name: 'Мероприятия в рамках конференции', slug: 'events' },
  PROG_FORUMS: { id: 'program_forums', name: 'Форумы', slug: 'forums' },

  // Выставка
  EXHIBITION: { id: 'exhibition_page', name: 'Выставка', slug: 'exhibition' },

  // Логистика
  LOG_PRACTICAL: { id: 'logistics_practical', name: 'Практическая информация', slug: 'practical' },
  LOG_VISA: { id: 'logistics_visa', name: 'Виза в Таджикистан', slug: 'visa' },
  LOG_PRESS: { id: 'logistics_press', name: 'Аккредитация прессы', slug: 'press' },
  LOG_FLIGHTS: { id: 'logistics_flights', name: 'Авиарейсы', slug: 'flights' },
  LOG_ACCOMMODATION: { id: 'logistics_accommodation', name: 'Размещение в гостинице', slug: 'accommodation' },
  LOG_WEATHER: { id: 'logistics_weather', name: 'Погода', slug: 'weather' }
}
...
export default function EventsManager() {
  ...
  const [selectedPage, setSelectedPage] = useState(PAGES.PARALLEL.id)
  ...
  return (
    <div className="elementor-builder">
      ...
      {/* Page Tabs */}
      <div className="elementor-page-tabs">
