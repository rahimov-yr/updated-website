...
// Sort alphabetically by name, but keep Tajikistan first
export const sortedCountries = [
  countriesData.find(c => c.code === 'TJ'),
  ...countriesData.filter(c => c.code !== 'TJ').sort((a, b) => a.name.localeCompare(b.name, 'ru'))
].map(country => ({
  ...country,
